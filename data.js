...
const IM = {
  ...
  brands: [
    ...
    { id: 'empty-apparel',      name: 'Empty Apparel',      city: 'Cape Town',     province: 'Western Cape',  category: 'Swimwear + Minimal RTW',  pieces: 6,  featured: true,  img: 'swim_01',  bio: 'Sculptural, recycled-fabric swimwear from Cape Town. Form-first, zero excess.' },
    { id: 'bird-named-frank',   name: 'A Bird Named Frank', city: 'Cape Town',     province: 'Western Cape',  category: 'Swimwear + Accessories',  pieces: 8,  featured: true,  img: 'swim_02',  bio: 'Coastal two-pieces and wool accessories. Quiet confidence, coastal roots.' },
    { id: 'blackcherry',        name: 'Blackcherry',        city: 'Durban',        province: 'KwaZulu-Natal', category: 'Swimwear + Dresses',      pieces: 10, featured: true,  img: 'swim_04',  bio: 'KZN-made swimwear and dresses. Ocean recycled nylon. Surf heritage, city edge.' },
    { id: 'bibi-rouge',         name: 'Bibi Rouge',         city: 'Johannesburg',  province: 'Gauteng',       category: 'Contemporary RTW',        pieces: 12, featured: false, img: 'prod_05',  bio: 'Joburg contemporary ready-to-wear. Fluid cuts, jewel tones, everyday wearability.' },
    { id: 'coco-lifestyle',     name: 'Coco Lifestyle',     city: 'Stellenbosch',  province: 'Western Cape',  category: 'Swimwear + Resort Wear',  pieces: 9,  featured: false, img: 'swim_05',  bio: 'Stellenbosch resort and swimwear. Winelands meets Atlantic. Unhurried luxury.' },
    { id: 'genevieve-motley',   name: 'Geneviève Motley',   city: 'Woodstock',     province: 'Western Cape',  category: 'Leather Goods + Swimwear',pieces: 14, featured: true,  img: 'acc_01',   bio: 'Full-grain leather goods and botanical swimwear. Zero-waste pattern. Woodstock studio.' },
    { id: 'silver-fig',         name: 'Silver Fig',         city: 'Franschhoek',   province: 'Western Cape',  category: 'Luxe Womenswear',         pieces: 15, featured: false, img: 'swim_08',  bio: 'Luxe, limited-run womenswear. Franschhoek atelier. Max 20 pieces per style.' },
    { id: 'white-rabbit-days',  name: 'White Rabbit Days',  city: 'Johannesburg',  province: 'Gauteng',       category: 'Contemporary RTW',        pieces: 33, featured: false, img: 'acc_04',   bio: 'Contemporary ready-to-wear for the modern Joburg woman. Silk scarves. Velvet blazers.' },
    { id: 'joy-jewellery',      name: 'Joy Jewellery',      city: 'Cape Town',     province: 'Western Cape',  category: 'Fine Jewellery',          pieces: 11, featured: true,  img: 'jewel_01', bio: '18ct gold-plated fine jewellery. Hand-assembled in Cape Town. Layered, architectural.' },
    { id: 'famke-jewellery',    name: 'Famke',              city: 'Cape Town',     province: 'Western Cape',  category: 'Metalwork Jewellery',     pieces: 7,  featured: false, img: 'jewel_08', bio: 'Recycled brass and silver. Made-to-order rings and cuffs. Cape Town studio.' },
    { id: 'indhi-design',       name: 'Indhi Design',       city: 'Pretoria',      province: 'Gauteng',       category: 'Beadwork + Textile',      pieces: 9,  featured: false, img: 'jewel_06', bio: 'Traditional Ndebele beadwork, contemporary silhouette. Pretoria. Technique-first.' },
    { id: 'hot-igloo',          name: 'Hot Igloo',          city: 'Port Elizabeth', province: 'Eastern Cape', category: 'Accessories + Jewellery', pieces: 18, featured: true,  img: 'acc_02',   bio: 'Raffia totes, copper earrings, canvas totes. Eastern Cape craft, everyday utility.' },
    { id: 'made-with-love',     name: 'Made With Love',     city: 'Knysna',        province: 'Western Cape',  category: 'Handcraft + Textile',     pieces: 28, featured: false, img: 'prod_03',  bio: 'Handcrafted textile pieces from the Garden Route. Slow, considered, tactile.' },
    { id: 'zindaba-collective', name: 'Zindaba Collective', city: 'Cape Town',     province: 'Western Cape',  category: 'Unisex + Streetwear',     pieces: 27, featured: false, img: 'prod_01',  bio: 'Unisex streetwear collective. Pan-African influences, Cape Town roots.' },
  ],
